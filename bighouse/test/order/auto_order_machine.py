...
#             self.__exchange = ConfigClass.CustomBinanceData()
#             self._symbol = symbol
...
#         response = None
#         try:
#             response = self.__exchange.fetch_ticker(self._symbol)
...
#         response = self.__exchange.create_order(f'{self._symbol}', 'limit', 'buy', buy_coin_number, price)
...
#         response = self.__exchange.cancel_order(self.orderId, self._symbol)
#         self.timestamp = response['timestamp']
#         self.order_status = response['status']
